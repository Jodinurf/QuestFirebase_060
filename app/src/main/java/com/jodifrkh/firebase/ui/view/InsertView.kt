...
import com.jodifrkh.firebase.ui.viewmodel.FormState
import com.jodifrkh.firebase.ui.viewmodel.InsertUiState
import com.jodifrkh.firebase.ui.viewmodel.InsertViewModel
...
fun FormMahasiswa(
    ...
    Column (
        ...
        OutlinedTextField(
            ...
            placeholder = { Text("Masukkan dosen pembimbing pertama") },
        )
        Text(
        ...
        OutlinedTextField(
            ...
            isError = errorState.dosenPembimbing1!= null,
            placeholder = { Text("Masukkan dosen pembimbing kedua") },
        )
        Text(
            text = errorState.dosenPembimbing1 ?: "",
            color = Color.Red
